  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 max-w-5xl mx-auto animate-fadeIn">
      ...
      <form onSubmit={handleSearch} className="space-y-4">
        ...
        <Button
          type="submit"
          className="w-full bg-gradient-to-r from-[#ffce05] to-[#e6b800] hover:from-[#e6b800] hover:to-[#e6b800] text-[#1a2f4a] font-bold py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-2xl hover:scale-[1.02] text-lg"
          size="lg"
        >
