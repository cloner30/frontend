              ...
              <>
                ...
                <div>
                  ...
                  <div 
                    ...
                    style={{
                      backgroundImage: `linear-gradient(rgba(26, 47, 74, 0.7), rgba(26, 47, 74, 0.7)), url('${selectedCity.image}')`,
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center text-white text-center p-8">
                      <div>
                        ...
                        {selectedCity.welcomeMessage && (
                          <p className="text-lg text-gray-200 mt-6 max-w-3xl mx-auto italic">
                            "{selectedCity.welcomeMessage}"
                          </p>
                        )}
                      </div>
                    ...
                    <Card className="border-l-4 border-[#d4af37]">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-3">
                          <MapPin className="h-5 w-5 text-[#d4af37] mr-2" />
                          <h3 className="font-bold text-[#1a2f4a]">Location</h3>
                        </div>
                    ...
                    <Card className="border-l-4 border-[#d4af37]">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-3">
                          ...
                          <h3 className="font-bold text-[#1a2f4a]">Best Time</h3>
                        </div>
                    ...
                    <Card className="border-l-4 border-[#d4af37]">
                      <CardContent className="p-6">
                        <div className="flex items-center mb-3">
                          ...
                          <h3 className="font-bold text-[#1a2f4a]">Emergency</h3>
                        </div>
                  ...
                  {/* Ziyarat Sites */}
                  <div>
                    <h2 className="text-3xl font-bold text-[#1a2f4a] mb-6">Holy Sites & Shrines</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {citySites.map((site) => (
                        <Card 
                          key={site.id}
                          className="group cursor-pointer hover:shadow-xl transition-all duration-300 border-2 hover:border-[#d4af37]"
                          onClick={() => handleSiteSelect(site)}
                        >
                          ...
                          <CardContent className="p-6">
                            <h3 className="text-xl font-bold text-[#1a2f4a] mb-2">{site.name}</h3>
                            <p className="text-sm text-gray-600 mb-1">{site.nameArabic}</p>
                            <Badge variant="outline" className="mb-3">{site.type}</Badge>
                            <p className="text-sm text-gray-700 line-clamp-3 mb-4">
                              {site.description}
                            </p>
                            <Button 
                              variant="ghost" 
                              className="w-full text-[#d4af37] hover:bg-[#d4af37]/10"
                            >
                              View Details
